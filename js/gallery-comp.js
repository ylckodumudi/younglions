...
! function(a, b) {
    ...
    ! function() {
        ...
        b.prototype.init = function() {
            ...
            }, this.s.backdropDuration), this.s.download , this.prevScrollTop = a(window).scrollTop()
...
! function(a, b) {
    ...
    ! function() {
        ...
        var b = {
            ...
            c = function(c) {
                return this.core = a(c).data("lightGallery"), this.core.s = a.extend({}, b, this.core.s), this.init(), this
            };
        c.prototype.init = function() {
            var b = this,
    ...
    ! function() {
        ...
        c.prototype.init = function() {
            ...
            var c, d = this,
                e = "",
                f = "",
                g = '<div class="lg-thumb-outer"><div class="lg-thumb group"></div></div>';
            ...
            d.core.$outer.find(".lg-thumb").html(e), c = d.core.$outer.find(".lg-thumb-item"), c.each(function() {
                ...
                var b = a(this);
                setTimeout(function() {
                    (d.thumbClickable && !d.core.lgBusy || !d.core.doCss()) && (d.core.index = b.index(), d.core.slide(d.core.index, !1, !0))
                }, 50)
...
! function(a, b) {
    ...
    ! function() {
        ...
        d.prototype.init = function() {
            ...
            (Math.abs(b.x - a.x) > 15 || Math.abs(b.y - a.y) > 15) && (d && (i <= -k ? i = -k : i >= -j && (i = -j)), c && (h <= -m ? h = -m : h >= -l && (h = -l)), d ? f.attr("data-y", Math.abs(i)) : i = -Math.abs(f.attr("data-y")), c ? f.attr("data-x", Math.abs(h)) : h = -Math.abs(f.attr("data-x")), e.s.core.useLeftForZoom ? f.css({
                left: h + "px",
                top: i + "px"
